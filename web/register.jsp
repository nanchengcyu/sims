...
<%--        <header class="layui-elip">学生信息管理系统</header>--%>
      <br>  <h1 style=" text-align: center; padding: 10px; color: white;">学生信息管理系统</h1>
    <br>
        <!-- 表单选项 -->
        <form class="layui-form" id="registerForm" action="${pageContext.request.contextPath}/registerServlet" method="post" onsubmit="return validateForm()">
            ...
            <div class="layui-input-inline">
                <div class="layui-inline" style="width: 100%">
                    <label class="layadmin-user-login-icon layui-icon layui-icon-face-smile"></label>
                    <input type="text" id="age" value="${age}" name="age" required lay-verify="required|number" placeholder="请输入年龄" autocomplete="off" class="layui-input">
                </div>
            </div>
...
<footer style="position:absolute;bottom:0;width:100%;height:30px; text-align: center;">© 学生信息管理系统</footer>
